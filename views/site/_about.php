            ...
            <div class="col-md-8 mb-4 ps-md-5">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4" data-aos="fade-up">
                        ...
                        <p><strong>Empatía:</strong> Escuchamos y entendemos las necesidades de nuestros clientes.</p>
                        <p><strong>Compromiso:</strong> Generamos empleo y trabajamos con proveedores hondureños.</p>
                        <p><strong>Empoderamiento:</strong> Nos mueve el deseo de crecer junto a nuestros clientes.</p>
                    </div>
                </div>
            </div>
        </div>
